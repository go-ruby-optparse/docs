...
`go-ruby-optparse/optparse` reimplements Ruby's OptionParser in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-optparse/optparse` directly, with no Ruby runtime;
