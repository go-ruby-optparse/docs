...
Contributions are welcome. `go-ruby-optparse/optparse` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-optparse/optparse`](https://github.com/go-ruby-optparse/optparse). This documentation site is in
[`github.com/go-ruby-optparse/docs`](https://github.com/go-ruby-optparse/docs). Start from the
